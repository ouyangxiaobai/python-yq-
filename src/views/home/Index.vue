  ...
  <div class="Spike">
    ...
    <el-row class="Spike-list">
      <el-col :span="24">
        <el-table :data="tableData" border style="width: 100%">
          ...
          <el-table-column prop="tel" label="电话号码" width="200px">
          </el-table-column>
    ...
    <el-dialog title="添加用户" :visible.sync="SpikeShow">
      <el-form :model="SpikeForm" :rules="SpikeRules" ref="SpikeForm">
        <el-form-item label="用户id" :label-width="SpikeWidth" prop="name">
          <el-input
        ...
        <el-form-item label="用户真名" :label-width="SpikeWidth" prop="start">
          <el-input
...
export default {
  ...
  methods: {
    ...
    searchword(val) {
      ...
      formdata.append("username", this.getusernma);
      axios
